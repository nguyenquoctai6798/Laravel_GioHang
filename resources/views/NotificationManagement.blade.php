...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <a href="{{asset('/CreateNotification')}}" class="btn btn-info active" aria-pressed="true">Tạo thông báo</a>
            <hr />
            <div class="row">
                ...
                <table style="width:100%; font-size:20px">
                    ...
                    @foreach ($lsNotification as $key => $value)
                        <tr></tr>
                            <td><img class="card-img-top" src="{{asset('public/Images')}}/<?php  echo $value->img ?>"
                                    alt="Card image cap"></td>
                            <td>{{$value->title}}</td>
                            <td> <button class='btn btn-info'><a style='color:white'
                                href="{{asset('/DetailNotification')}}/{{$value->id}}">Chi tiết</a></button> </td>
                            <td> <button class='btn btn-success'><a style='color:white'
                                        href="{{asset('/EditNotification')}}/{{$value->id}}">Sửa</a></button> </td>
                            <td><button class='btn btn-danger'><a style='color:white'
                                href="{{asset('/DeleteNotification')}}/<?php echo $value->id ?>"<?php echo $value->Id ?>>Xóa</a></button></td>
