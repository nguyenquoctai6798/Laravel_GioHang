...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <a href="{{asset('/CartPayment')}}"><img src="{{asset('public/img/shopping.png')}}" style = "width:60px; margin-left:30px" alt=""></a>
            ...
            <div class="row">
                  <?php foreach ($lsProduct as $key => $value) { ?>
                    <div class="card">
                            <div class="col-md-3">
                                <img class="card-img-top" src="{{asset('public/Images')}}/<?php echo $value->Img?>" alt="Card image cap">
                                <div class="card-body">
                                    <div class="card-title"><b style="font-size:22px"><?php echo $value->Name?></b></div>
                                    <p class="card-text"><i><?php echo 'Giá: ' . $value->Price ?></i></p>
                                    <a  href="{{asset('BuyProduct')}}/<?php echo $value->Id?>" class="btn btn-info">Buy</a>
                                </div>
                            </div>
                        </div>
                  <?php }?>
