                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="{{asset('public/img')}}/<?php echo Auth::user()->img ?>" class="user-image"
                                    alt="User Image">
                ...
                Loại tin tức: 
                    <select class="form-control" name="id_notification" id="">
                        ...
                        @foreach ($lsNotificationType as $key => $value)
                                @if($value->id == $notification->id_notification)
                                 <option disabled value= {{$value->id}} selected>{{  $value->name }}</option>
                    ...
                    Tiêu đề: <div class="form-group">
                        <input type="text" class="form-control" name="title" id="" aria-describedby="helpId" disabled
                           disabled value="<?php echo $notification->title ?>" ?>
                    </div>
                   
                    Hình:<br/> <img style="height:100px" src= "{{asset('public/Images')}}/<?php echo $notification->img?>" alt="">
                    <br/><br/>
                    Chi tiết:<div class="form-group">
                   
                            <textarea  style="height:400px"  type="text" class="form-control" name="Description" id="" aria-describedby="helpId" disabled
                            placehoder = 'Nhập mô tả'> <?php echo $notification->Content ?> </textarea>
                    </div>
