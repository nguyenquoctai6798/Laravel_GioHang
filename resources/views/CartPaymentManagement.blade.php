        ...
        <div class="content-wrapper">
          ...
          <hr/>
            ...
            <table style="width:100%; font-size:20px">
                    ...
                    <?php 
                        foreach ($lsPayment as $key => $item) { ?>
                            <tr>
                                    <td><?php echo $item->gmail ?></td>
                                    <td><?php echo $item->totalPay ?></td>
                                    <td><a href="{{asset('/DetailCartPaymentManagement')}}/<?php echo $item->id?>" class="btn btn-info"> Chi tiết </a></td>
                                  </tr>
                        <?php }?>
