    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <?php if(Session::has('error')){
               ...
               <div class = "Search">
                    <form action="{{url('SearchNotification')}}" method="GET">
                        @csrf
                            <div class="row">
               ...
               <div class="row news_list">
                <?php foreach ($lsNotification as $key => $value) { ?>
                          <div class="news_item">
                              <img class="card-img-top" src="{{asset('public/Images')}}/<?php echo $value->img?>" alt="Card image cap">
                              <div class="card-body">
                                  <div class="card-title"><b style="font-size:22px"><?php echo $value->title?></b></div>
                                  <a  href="{{asset('/ShowNotification')}}/{{$value->id}}" class="btn btn-info">Chi tiết</a>
                              </div>
                          </div>
                <?php }?>
