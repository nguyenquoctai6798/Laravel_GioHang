    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php }} ?>
                <form action="{{asset('/CreateProduct')}}" method='POST' enctype="multipart/form-data">
                    @csrf

                    Loại sản phẩm: 
                    <select class="form-control" name="id_producttype" id="">
                    <?php 
                    ...
                    Tên Sản phẩm: <div class="form-group">
