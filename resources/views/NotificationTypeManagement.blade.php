        ...
        <div class="content-wrapper">
            ...
            <?php if(Session::has('success')){
                $success = Session::get('success');?>
                   ...
                   <form action="{{asset('/AddNotificationType')}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-sm-8">
                ...
                <ol>
                          ...
                          @foreach ($lsNotificationType as $key => $value)
                               <li style="font-size:30px"> {{ $value->name }}  <a href="{{asset('/DeleteNotificationType')}}/{{$value->id }} "> <i class="fas fa-trash-alt"></i></a> </li>
                          @endforeach
